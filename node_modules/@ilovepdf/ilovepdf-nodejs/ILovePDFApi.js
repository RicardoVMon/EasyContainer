...
var ILovePDFApi = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        return [2 /*return*/, this.xhr.post("".concat(globals_json_1.default.API_URL_PROTOCOL, "://").concat(globals_json_1.default.API_URL, "/").concat(globals_json_1.default.API_VERSION, "/task"), __assign({ secret_key: this.auth.secretKey }, params), {
                                headers: [
     ...
     * @inheritdoc
     */
    ILovePDFApi.prototype.getSignatureList = function (page, pageLimit) {
        if (page === void 0) { page = 0; }
        if (pageLimit === void 0) { pageLimit = 20; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, ILovePDFCoreApi_1.default.getSignatureList(this.auth, this.xhr, page, pageLimit)];
            });
        });
    };
    /**
